...
public class WebdiverAPITest01 {
	...
	public void testWebdriverAPIs() throws InterruptedException {
		...
		WebElement chk_remember = driver
				.findElement(By.xpath("//div[label[text()='remember']]/input[contains(@class,'checkbox')]"));
		...
		/**
		 * 
		 * Action ... click X double click sendkeys X keyDown, keyUp
		 * clickAndHold release moveToElement contextClick dragAndDrop
		 */
		...
		// verify div_display_after_mouse_over is not displayed before
		// moveToElement
		...
		// verify div_display_after_clickAndHold is not displayed before
		// clickAndHold
